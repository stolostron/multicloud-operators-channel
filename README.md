...
Keep in mind, if you were using this operator before, you might need to migrate your resource api-group and version from `app.ibm.com/v1alpha1` to `multicloud-apps.io/v1`. Example can be found under the `examples` folder.
...
*Note*: If you see the following error, do not worry. We kept the CR generated by operator-sdk in the Deploy folder for consistency.
