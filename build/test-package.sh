...
PATH=/go/src/github.com/stolostron/multicloud-operators-channel/test_tmp/bin/kubebuilder/bin:${PATH}
export PATH
export KUBEBUILDER_ASSETS=/go/src/github.com/stolostron/multicloud-operators-channel/test_tmp/bin/kubebuilder/bin
