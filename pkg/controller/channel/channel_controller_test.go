...
func TestReconcile(t *testing.T) {
	...
	instance := &appv1alpha1.Channel{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Channel object and expect the Reconcile and Deployment to be created
