...
var AddToManagerFuncs []func(manager.Manager, record.EventRecorder, logr.Logger, *utils.ChannelDescriptor, *helmsync.ChannelSynchronizer, *gitsync.ChannelSynchronizer) error
